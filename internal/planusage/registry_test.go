...
func TestGroupByKeyDedup(t *testing.T) {
	...
	accs := []AccountView{
		fakeAcc{name: "a1", provider: "opencode-go", base: "https://opencode.ai/zen/go/v1", key: "same"},
		fakeAcc{name: "a2", provider: "opencode-go", base: "https://opencode.ai/zen/go/v1", key: "same"},
		fakeAcc{name: "b1", provider: "opencode-go", base: "https://opencode.ai/zen/go/v1", key: "other"},
