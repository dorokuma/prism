...
> Version: v0.17.0  Date: 2026-08-12  Status: living document
...
| `trusted_proxies` | array | — | CIDR list whose X-Forwarded-For/X-Real-IP hops are trusted for client-IP resolution (rate limiting). Whole-address-space ranges (`0.0.0.0/0`, `::/0`) are rejected at load: they would let any client spoof the forwarding headers past the IP rate limiter |
